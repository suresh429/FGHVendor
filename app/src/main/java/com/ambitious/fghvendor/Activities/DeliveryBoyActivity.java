...
import com.ambitious.fghvendor.Adapters.DeliveryListAdpter;
...
public class DeliveryBoyActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Utility.isNetworkConnected(mContext)) {
            ...
            getUsers(uid, "Delivery", iv_Bck,latitude,longitude);
           // getUsers(uid, "Delivery", iv_Bck);
        } else {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (status.equalsIgnoreCase("1")) {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                deliveries.add(donor);


                            }


                            adpter = new DeliveryListAdpter(mContext, deliveries);
