...
public class VaterinaryLoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vaterinary_login);
        finds();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_Signup:
                startActivity(new Intent(mContext, VaterinarySignupActivity.class));
