...
public class FoodBankLoginActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_bank_login);
        finds();
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_Signup:
                startActivity(new Intent(mContext, FoodBankSignupActivity.class)
                        .putExtra("city", "" + city)
                        .putExtra("lat", "" + lat)
                        .putExtra("lon", "" + lon)
                );
            ...
            public void onResponse(Call<ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        System.out.println("FoodBankLogin" + object);
