...
import com.ambitious.fghvendor.Adapters.SanitizationListAdpter;
...
public class SanitizationServiceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private SanitizationListAdpter adpter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Utility.isNetworkConnected(mContext)) {
            ...
            getUsers(uid, "Sanitization", iv_Bck);
        } else {
    ...
    private void filter(String text) {
        ...
        ArrayList<Sanitization> temp = new ArrayList();
        for (Sanitization d : sanitizations) {
    ...
    private void getUsers(String uid, String type, ImageView view) {
            ...
            public void onResponse(Call<ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        System.out.println("Sanitizations" + object);
                        ...
                        if (status.equalsIgnoreCase("1")) {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                Sanitization donor = new Sanitization();
                                donor.setId(user_id);
                                donor.setName(name);
                                ...
                                sanitizations.add(donor);


                            }


                            adpter = new SanitizationListAdpter(mContext, sanitizations);
