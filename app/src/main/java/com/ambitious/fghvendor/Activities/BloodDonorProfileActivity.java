...
public class BloodDonorProfileActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView tv_Detail, tv_Histry, tv_Name, tv_Rating, tv_Address, tv_Bloodgrp;
    private RelativeLayout rl_Bloodgroup, rl_Whatsapp, rl_Call;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras() != null) {
            ...
            try {
                ...
                tv_Bloodgrp.setText(blood_group);
    ...
    private void setData(String type) {
        if (type.equalsIgnoreCase("detail")) {
            ...
            rl_Bloodgroup.setVisibility(View.VISIBLE);
            ...
            rv_Histry.setVisibility(View.GONE);
            rl_Bloodgroup.setVisibility(View.GONE);
    ...
    private void finds() {
        ...
        tv_Bloodgrp = findViewById(R.id.tv_Bloodgrp);
        bar_Rating = findViewById(R.id.bar_Rating);
        rl_Bloodgroup = findViewById(R.id.rl_Bloodgroup);
