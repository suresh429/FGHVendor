...
import com.ambitious.fghvendor.Adapters.AmbulanceDriverAdapter;
...
public class AmbulanceDriverListActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private AmbulanceDriverAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (name.equalsIgnoreCase("Book 108")) {
            user_type = "108 ambulance";
        } else if (name.equalsIgnoreCase("Private Ambulance")) {
            user_type = "Private ambulance";
        } else if (name.equalsIgnoreCase("Team Ambulance")) {
            user_type = "Team ambulance";
        }
        ...
        if (Utility.isNetworkConnected(mContext)) {
            ...
            getUsers(uid, user_type, iv_Bck,latitude,longitude);
        } else {
...
//        setData();
    ...
    private void filter(String text) {
        ...
        ArrayList<AmbuDriver> temp = new ArrayList();
        for (AmbuDriver d : drivers) {
    ...
    private void getUsers(String uid, String user_type, final ImageView view, String latitude, String longitude) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (status.equalsIgnoreCase("1")) {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                AmbuDriver driver = new AmbuDriver();
                            ...
                            if (drivers.size() > 0) {
                                adapter = new AmbulanceDriverAdapter(mContext, drivers);
