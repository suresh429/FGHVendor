...
import com.ambitious.fghvendor.Adapters.MarketGroupAdapter;
...
public class MarketPricesProfileActivity extends AppCompatActivity implements View.OnClickListener, PaymentResultListener {

    private Context mContext = this;
    private ImageView iv_Bck, iv_User;
    private TextView tv_Head, tv_Name, tv_Rating, tv_Address, tv_Pay, txtIfscCode, txtAccountNo;
    ...
    private MarketGroupAdapter adapter;
    private RelativeLayout rl_Call, rl_Whatsapp, rl_Loader;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_market_prices_profile);
        finds();
...
//                wallet = "0";
            ...
            try {
                ...
                String product_weight = object.optString("weight");
                ...
                marketProductArrayList = new ArrayList<>();
                ...
                for (int i = pNames.size() - 1; i >= 0; i--) {
                    ...
                    marketProductArrayList.add(group);

                }

                adapter = new MarketGroupAdapter(mContext, marketProductArrayList);
                GridLayoutManager manager = new GridLayoutManager(mContext, 3);
                manager.setOrientation(RecyclerView.VERTICAL);
                rv_Groups.setLayoutManager(manager);
...
//                    Toast.makeText(mContext, "Amnt=>" + Amnt + "\nWallet=>" + n_Wallet, Toast.LENGTH_SHORT).show();
    ...
    private void confirmationDialog(String uid, String user_id, String amnt, String n_Wallet, String wallet, View v){
        AlertDialog.Builder builder = new AlertDialog.Builder(MarketPricesProfileActivity.this);
