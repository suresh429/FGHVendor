...
public class HelpingSoldierProfileActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_helping_soldier_profile);
        finds();
        setData("detail");
