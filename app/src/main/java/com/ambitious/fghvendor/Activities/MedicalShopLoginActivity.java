...
public class MedicalShopLoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medical_shop_login);
        finds();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_Signup:
                startActivity(new Intent(mContext, MedicalShopSignupActivity.class));
