...
public class RMPDoctorHomeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_r_m_p_doctor_home);
        finds();
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            public boolean onMenuItemClick(MenuItem item) {
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.update:
                        startActivity(new Intent(mContext, RMPUpateActivity.class));
                        Animatoo.animateCard(mContext);
                        break;
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        new Handler().postDelayed(new Runnable() {
                            ...
                            public void run() {
                                rl_Loader.setVisibility(View.GONE);
                                Intent intent = new Intent(mContext, RMPLoginActivity.class);
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (status.equalsIgnoreCase("1")) {
                            ...
                            getPatients(uid, "rmppatient", view);
