...
public class OxygenBankLoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String type = "", city = "", lat = "", lon = "";


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_oxygen_bank_login);
        finds();
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_Signup:
                startActivity(new Intent(mContext, OxygenBankSignupActivity.class)
                        .putExtra("city", "" + city)
                        .putExtra("lat", "" + lat)
                        .putExtra("lon", "" + lon));
                Animatoo.animateCard(mContext);
...
// String register_id = FirebaseInstanceId.getInstance().getToken();
        ...
        if (email.equalsIgnoreCase("")) {
            ...
            CustomSnakbar.showDarkSnakabar(mContext, v, "Please select which type of Service of your bank!");
        } else {
