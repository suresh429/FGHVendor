...
import com.ambitious.fghvendor.Adapters.BloodGroupAdapter;
...
public class BloodBankProfileActivity extends AppCompatActivity implements View.OnClickListener, PaymentResultListener {
    ...
    private BloodGroupAdapter adapter;
...
//                wallet = "0";
            ...
            try {
                ...
                for (int i = 0; i < bgrp.length; i++) {
                    ...
                    BloodGroup group = new BloodGroup(bgrp[i], prc[i]);
                    bloodGroups.add(group);

                }

                adapter = new BloodGroupAdapter(mContext, bloodGroups);
...
//                    Toast.makeText(mContext, "Amnt=>" + Amnt + "\nWallet=>" + n_Wallet, Toast.LENGTH_SHORT).show();
    ...
    private void confirmationDialog(String uid, String user_id, String amnt, String n_Wallet, String wallet, View v){
        AlertDialog.Builder builder = new AlertDialog.Builder(BloodBankProfileActivity.this);
