...
public class VehicleLoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_Signup:
                startActivity(new Intent(mContext, VehicleSignupActivity.class)
                        .putExtra("city", "" + city)
                        .putExtra("lat", "" + lat)
                        .putExtra("lon", "" + lon));
                Animatoo.animateCard(mContext);
            ...
            public void onResponse(Call<ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        System.out.println("VehicleLogin" + object);
